...
<head>
    ...
    <title>Formmi Developpement Web</title>
 ...
 include '../connexion.php';
     ...
     $sql = "SELECT * FROM ecole WHERE id >0 AND id < 5";
           ...
           <div class="container_text">
              ...
              <?php } else{?>
                ...
                <p class="podcast">Podcast </p>
                    <img id=<?php echo $data['play']; ?> src="images/play_pause/play-jaune.png" alt="">
                    <img id=<?php echo $data['pause']; ?> src="images/play_pause/pause-jaune.png" alt="">

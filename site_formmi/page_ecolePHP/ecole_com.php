...
<head>
    ...
    <title>Formmi Communication</title>
  ...
  include '../connexion.php';
     ...
     $sql = "SELECT * FROM ecole WHERE id >12 AND id < 17";
           ...
           <div class="container_text">
              ...
              <?php } else{?>
                ...
                <p class="podcast">Podcast </p>
                    <img id=<?php echo $data['play']; ?> src="images/play_pause/play-bleu.png" alt="">
                    <img id=<?php echo $data['pause']; ?> src="images/play_pause/pause-bleu.png" alt="">
